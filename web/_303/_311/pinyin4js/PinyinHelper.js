...
export var PINYIN_TABLE = PinyinResource.getPinyinResource();  //单字字典
...
export class PinyinHelper {
     ...
     * @param {string} str 
     */
    static convertToPinyinStringArray(str)
    {
        var format = PinyinFormat.WITH_TONE_NUMBER;
        var result = new Array();
        function Add(result_index, pinyin, old_string_index)
        {
            let new_result_item;
            new_result_item = new Object();
            result[result_index] = new_result_item;
            new_result_item.pinyin = pinyin;
            new_result_item.old_string_index = old_string_index;
        }
        var pos = 0
        str = ChineseHelper.convertToSimplifiedChinese(str);
        var i = 0;
